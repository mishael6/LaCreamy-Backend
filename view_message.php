...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['response'])) {
    ...
    if ($stmt->execute()) {
        ...
        // mail($message['email'], "Response from LA CREAMY CAKEIST", $response);
    }
    $stmt->close();
}
...
<head>
    ...
    <title>View Message #<?php echo $message['id']; ?> - Admin Dashboard</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="navbar">
        <h1>View Message #<?php echo $message['id']; ?></h1>
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="info-group">
                ...
                <p>
                    <a href="tel:<?php echo htmlspecialchars($message['phone_number']); ?>">
            ...
            <div class="info-group">
                ...
                <p><?php echo date('l, F j, Y \a\t g:i A', strtotime($message['created_at'])); ?></p>
            </div>
            ...
            <div class="contact-actions">
                ...
                <a href="tel:<?php echo htmlspecialchars($message['phone_number']); ?>" class="btn btn-secondary">
                    Call Customer
                </a>
            </div>
        </div>
        ...
        <?php if ($message['admin_response']): ?>
            <div class="card">
                ...
                <div class="response-box">
                    <p class="message-content"><?php echo nl2br(htmlspecialchars($message['admin_response'])); ?></p>
                </div>
                <div class="info-group" style="margin-top: 20px;">
                    <label>Responded At</label>
                    <p><?php echo date('l, F j, Y \a\t g:i A', strtotime($message['responded_at'])); ?></p>
                </div>
            </div>
        <?php else: ?>
            <div class="card">
                ...
                <form method="POST">
                    <div class="info-group">
                        <label>Your Response to <?php echo htmlspecialchars($message['full_name']); ?></label>
                        <textarea name="response" required placeholder="Type your response here...

Example:
Dear <?php echo htmlspecialchars($message['full_name']); ?>,

Thank you for contacting LA CREAMY CAKEIST. We received your message and would be happy to help you.

[Your response here]

Best regards,
LA CREAMY CAKEIST Team"></textarea>
                    </div>
